...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/563182454f6200828f7a508a39b012e65ff4679eeb643002b1cbab9b6381b486.jpg}}

\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/03e55c5fcd0880abea3659c6281c70dd03014b726e8731a9cf3c3cb7f805a62e.jpg}}

\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/15ceb4e38f01fdec6e9ecb6be9564590250c828bb89032071de6ffb9425025ab.jpg}}

\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/8d7b714d2df959800f87785ee1b877f7fdfc2de81b9bfb60d0e989f6a761d090.jpg}}

\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/c3ff3e74c51867b22bf518786bcd8078c78e1d83eb2e4c8350ae391680c87e95.jpg}}

Figure 1 Benchmark score per task of MiMo-V2.6-Pro and MiMo-V2.6-Flash
throughout RL training.

\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/65d516da9543d3f13a8c34b9851924de25e6d630099d69a1e7bbd88b2afbe6de.jpg}}
...
6.2 Harness Pool and Payload Porter: Large-Batch RL with Multiple
Harnesses . 27\\
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/80846bdb6b58805054d6906fc420abb05a89328851d452ae336116b75a19724e.jpg}}
...
\multirow{7}{*}{Main Block} & Layers (Total/SWA/GA) & 48/39/9 &
70/60/10 \\
...
\# Total Parameters \# Active Parameters & 310B & 1.02T & \\
\multirow{7}{*}{MiMo-ViT} & & 15B & 42B \\
& Layers (Total/SWA/GA) & 28/24/4 & \\
& Hidden Size & 1280 & \\
& Attention Heads (Q/KV) & 32/8 & \\
& Head Dimension & 64 & \\
& Patch Size (T × H × W) & 2 × 16 × 16 & \\
& Sliding Window Size (Left/Right) Spatial Merge Size & 64/64 & \\
& \# Parameters & 2×2 681M & \\
\multirow{7}{*}{Audio Tokenizer Encoder} & Layers (Total/SWA/GA) &
24/12/12 & \\
& Hidden Size & 1024 & \\
...
& Codebooks & 20 & \\
\multirow{5}{*}{Audio Patch Encoder} & \# Parameters & 308M & \\
& Layers & 6 & \\
& Hidden Size & 1024 & \\
& Attention Heads (Q/KV) & 16/16 & \\
& Head Dimension Attention Group Size & 64 4 & \\
\multirow{5}{*}{} & \# Parameters & 127M & \\
& Layers (Total/SWA/GA) & 5/5/0 & 5/5/0 \\
& Hidden Size & 4096 & 6144 \\
& SWA Heads (Q/KV) & 64/8 & 128/8 \\
& Sliding Window Size & 1024 & 1024 \\
& GA Heads (Q/KV) Head Dimensions (QK/V) & 64/4 128/128 & 128/8
128/128 \\
\end{longtable}
}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/809b01f72f83eb1cedb49be6b1a7883a48a0bd794c18e04ed8a47ced9360ae6b.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/c536e6e9f740d8147a897d751ac2d1b6346bce68fe0c475d79b14eafc932c115.jpg}}
...
\[
\mathcal { L } ( \theta ) = - \mathbb { E } _ { q \sim \bigcup _ { d } _ { \mathbf { \mathcal { D } } _ { d } } , \{ \mathbf { \mathcal { D } } _ { i } \} _ { i = 1 } ^ { G } \sim \mu _ { \theta _ { \mathrm { o l d } } } ( \cdot | q ) } \left[ \frac { 1 } { \sum _ { i = 1 } ^ { G } | o _ { i } | } \sum _ { i = 1 } ^ { G } \sum _ { t = 1 } ^ { | o _ { i } | } r _ { i , t } M _ { i , t } A _ { i } \log \pi _ { \theta } ( o _ { i , t } \mid q , o _ { i , < t } ) \right] ,\tag{1}
\]
...
three parts. The first is rollout: for every prompt � drawn from the
union of task datasets \(\cup _ { d } \mathcal { D } _ { d }\) , the
rollout policy \(\mu _ { \theta _ { \mathrm { o l d } } }\) generates a
group of � candidate solutions \{��\}. The second is grading: we invest
...
correctness. Motivated by this, we devote substantial efort to building
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/d910ad93450ef70d5f995cfd5937e5e09eae70446585315298ac79aba74f3380.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/b76f04bc649fcf09d095412b001d307056b1a741e68b97a0e7aef62f9b590239.jpg}}
...
\hline
Install and read Uses a newer release of the target package as an answer
& Task (pytest): Fix Windows conftest.py imports broken by path
lowercasing. Thinking: "Let me check the pytest changelog or GitHub to
see if \\
\hline
key, copying a fix absent from the assigned checkout. &
there\textquotesingle s a more recent fix." Action: pip install
pytest==5.4.3; inspect the installed source. \\
\hline
Fetch upstream source Downloads an upstream file or patch that already
contains the & Task (Astropy): Correct the misleading error when a
required TimeSeries column is removed. \\
\hline
fix, exposing the code changes & Thinking: "Let me just look at the file
directly from the GitHub raw URL." \\
\hline
needed to pass the tests. & Action: curl
.../astropy/timeseries/core.py \\
\hline
Clone upstream & Task (Matplotlib): Stop ax.clear() from restoring
hidden ticks and \\
\hline
Reads a newer upstream & labels on shared axes. \\
\hline
checkout to reconstruct the published fix missing from the & Thinking:
"Let me directly fetch and inspect the relevant files from the \\
\hline
assigned historical commit. & latest matplotlib." Action: git clone
.../matplotlib.git; inspect axis.py. \\
\hline
Look up a solution & Task (Django): Fix MultiValueField ignoring
required subfields. \\
\hline
& Searches issue discussions, pull Thinking: "Let me get more info -
changesets and the fix that was \\
\hline
requests, or linked commits for applied." & the original solution and
uses it Action: Read the change history of Django ticket \#29205. \\
\hline
to guide the patch. Probe versions & \\
\hline
Finds a newer release to & Task (Sphinx): Remove the spurious return
type from class documentation. \\
\hline
download and compare for its fix. The probe is a precursor to versions."
& Thinking: "Let me look for the fix. The issue is likely fixed in
later \\
\hline
\end{longtable}
}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/63409c52f8a78f2a465323071de436f9ff3428dc5cb455d01a34f2873de33c25.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/4d11448856c2f513d211d89656f8602a7b08e48aceb981a0e922e715bd2e7a8d.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/b5feb8dac57635ced9b864814a4757925a73042bdf57462955e011101756c962.jpg}}
...
magnitude is ofset by reducing penalties on unflagged negative tokens:
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/2aceabd7abaea5663daef317169315b637f1af40c5b8b0eb3a147064563f2be5.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/05afed0dc3b6a6ff8edb83fd1d2d8fbac26698d776f2005494d9fa7c2e54e4a2.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/c0f77c9f59cd1c7d245eb0164d34405a2bee8073994d07d9de5078c5a08f1802.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/d16ba812ea325ab3a6f0c5d613dfe741023f8ea5f79dfa079863b87c30e96b4d.jpg}}

\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/5977f57a82f575d068bf72798969d0d9f67e03dbcfa21527a5ee77bdcab624a7.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/0f47c53a80302ab46c28e3ed47c32fe62c69f6b3c1560c8241a0e6f1fd5172f2.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/605b70600da02891005a77a243724043bf0da94a06f945d6968220d824db29a0.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/56abac7924c5e656c0122f91a44738597feab116191195c5be058c7050025384.jpg}}
...
points yields � complete history prefixes \(h _ { i } ,\) each of which
can initialize a separate student-generated turn \(y _ { i }\) for
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/7eb175a73bd897a7cf3049f739d0510029962530418bb7580ee75dda166dece5.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/18208ab1d89c14634db95c116636d4e24b50fdd71e67a6721c8c57b7fb5b8d30.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/1ba3a9bfd797271372b1f73966603bb3e8b2f79459cfd294a93b75a51f023eff.jpg}}
...
Training time, credit-assignment latency, staleness expiry, and replay
are excluded.

\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/e701ab1d883dc9d3afb4b594322f884ded46960bc61580c10e242a54fd135f1e.jpg}}
...
JobBench & avg@1 & 2.6 28.5 & 18.3 62.2 & 25.2 & \\
MiMo General Bench (mini) avg@1 & & & & 70.6 & \\
\multicolumn{6}{@{}l@{}}{%
Visual} \\
...
sufers from clear layout issues. After distillation,
...
efective incorporation of image assets, as exemplified by the
...
quantitative trajectory (61.7 → 64.0 → 72.4) observed in Table 6,
...
Held-out harnesses} & \\
\hline
Model & mini- harness1 & mini- harness2 & mini- harness3 & mini-
harness4 & codex & claude code & mini-swe- agent & Mean \\
\hline
\multicolumn{9}{@{}l@{}}{%
SWE-bench Verified} \\
\hline
...
improving solution quality and token eficiency. Evaluations across
public and internal benchmarks demonstrate the efectiveness of this
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/0be340694d4bd8974650d3f5f3c2263e177ca5d16309bf4ccf9506638767590c.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/8b84efa93ab199dae465b169912fb2ac62310e8dd83c2a9038adb37df2f4dd1e.jpg}}

\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/886705efb72ea19bcaa2a1c7f16c254926069566bed62d806531b9247c5ec18c.jpg}}

\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/53fa55f4d8e781c346ea4d3b7d9d0f3b16dcb85ffb552890d1cf66b275159e8e.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={image}]{images/3fdffc41a05ca39743623b0ae9c1ddb2bc8c378e9cefb825d32c605d0e07141e.jpg}}
